                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-obsidian/50 rounded border border-border-edge text-xs">
                    <div>
                      ...
                      <strong className="text-mist">{details.provider || "Direct / Core"}</strong>
                    </div>
                    <div>
                      <span className="text-smoke">Connected Account:</span>{" "}
                      <strong className="text-mist">{details.account_reference || "Default Platform Context"}</strong>
                    </div>
                    {details.recipient && (
                      <div>
                        <span className="text-smoke">Recipient:</span>{" "}
                        <strong className="text-mist">{details.recipient}</strong>
                      </div>
                    )}
                    {details.location && (
                      <div>
                        <span className="text-smoke">Location:</span>{" "}
                        <strong className="text-mist">{details.location}</strong>
                      </div>
                    )}
                    {details.time && (
                      <div>
                    ...
                    {details.fees !== undefined && (() => {
                      ...
                      return (
                        <div>
                          <span className="text-smoke">Mandatory Fees / Taxes:</span>{" "}
                          <strong
                    ...
                    {details.data_recipients && details.data_recipients.length > 0 && (
                      <div className="md:col-span-2">
                        ...
                        <span className="text-ash">{details.data_recipients.join(", ")}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {details.content && (
                    <div className="p-3 bg-obsidian/30 rounded border border-slate text-xs text-mist">
                      <strong className="text-ash block mb-1">Proposed Content:</strong>
                      <p>{details.content}</p>
                    </div>
                  )}
                          ...
                          return (
                            ...
                            >
                              <div className="space-y-0.5">
                                <div className="font-medium text-mist">{act.description}</div>
