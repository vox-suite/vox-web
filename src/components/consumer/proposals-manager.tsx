          ...
          <div className="space-y-6">
            {proposals.map((proposal) => {
              ...
              return (
                <div
                  key={proposal.id}
                  className="p-5 border border-border-edge bg-ink rounded-lg space-y-4"
                ...
                >
                  <Row spread>
                    <div>
                      ...
                      <h4 className="text-base font-semibold text-pure-white">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-obsidian/50 rounded border border-border-edge text-xs">
                    ...
                    {details.price !== undefined && (
                      <div>
                        ...
                        <strong className="text-pure-white font-mono text-sm">
                    ...
                    {details.fees !== undefined && (
                      <div>
                        ...
                        <strong className="text-mist font-mono">
                          {details.currency || "USD"}{" "}
                          {Number(details.fees).toFixed(2)}
                        </strong>
                      </div>
                    )}
                    <div>
                          ...
                          {details.grouped_actions.map((act) => (
                            ...
                            >
                              ...
                              <div className="text-right">
                                {act.price !== undefined && (
                                  <div className="font-mono text-pure-white font-medium">
                                    {details.currency || "USD"}{" "}
